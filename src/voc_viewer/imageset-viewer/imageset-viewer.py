...
class VOCViewer(tk.Tk):
    ...
    def init_layout(self, im_dir, anno_dir, save_dir, max_width, max_height, box_thick):
        ...
        self.width = (int)(0.4 * self.winfo_screenwidth())
        self.height = (int)(0.5 * self.winfo_screenheight())
        ...
        main_frame_width = (int)(0.5*self.width)
        ...
        # side_frame
        side_frame.rowconfigure(0, weight=10)
        side_frame.rowconfigure(1, weight=90)
        v = tk.StringVar()
        v.set("Image File List");
        image_names_label = tk.Label(side_frame, textvariable=v, bg=self.bg, fg=self.fg)
        v.set("Image File List");
    ...
    def callback(self, event=None):
        ...
        if im_id:
            ...
            if im_ext in self.supported_im_ext:
                ...
                print (os.path.basename(im_pth))
                #v.set(os.path.basename(im_pth))
    ...
    def get_tkim(self, im_pth):
        ...
        show_width = 640; show_height = 640;
...
def example1():
    ...
    """
    #app = VOCViewer(im_dir = "/prm-mnt/osni-scratch/Mustafa/Images_rect_VOC/Drainage/JPEGImages/", anno_dir ="/prm-mnt/osni-scratch/Mustafa/Images_rect_VOC/Drainage/Annotations/")
    app = VOCViewer(im_dir = "./Projects/2021/Detection/Datasets/VOCdevkit/VOC2012/JPEGImages/", anno_dir ="./Projects/2021/Detection/Datasets/VOCdevkit/VOC2012/Annotations/")
...
def example2():
    ...
    app = VOCViewer(im_dir = '/Users/chris/data/VOC2007/JPEGImages',   # image directory
                    ...
                    max_width =  800,   # max allowed shown image width is 1000
